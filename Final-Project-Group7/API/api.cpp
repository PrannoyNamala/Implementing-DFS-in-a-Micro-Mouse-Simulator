...
namespace fp {
    int API::mazeWidth() { // Definition of mazeWidth Function
    ...
    int API::mazeHeight() { // Definition of mazeHeight Function
    ...
    bool API::wallFront() { // Definition of wallFront Function
    ...
    bool API::wallRight() { // Definition of wallRight Function
    ...
    bool API::wallLeft() { // Definition of wallLeft Function
    ...
    void API::moveForward() { // Definition of moveForward Function
    ...
    void API::turnRight() { // Definition of turnRight Function
    ...
    void API::turnLeft() { // Definition of turnLeft Function
        std::cout << "turnLeft" << std::endl; // Prompt to turn robot left 90 degrees
        std::string ack; // Generate string to handle response
        std::cin >> ack; // MMS inputs the command to turn left
    }

    void API::setWall(int x, int y, char direction) { // Definition of setWall Function
        std::cout << "setWall " << x << " " << y << " " << direction
                  << std::endl; // Prompt that wall has been set at node (x,y) in direction (direction)
    }

    void API::clearWall(int x, int y, char direction) { // Definition of clearWall Function
        std::cout << "clearWall " << x << " " << y << " " << direction
                  << std::endl; // Prompt that wall has been cleared at node (x,y) in direction (direction)
    }

    void API::setColor(int x, int y, char color) { // Definition of setColor Function
        std::cout << "setColor " << x << " " << y << " " << color
                  << std::endl; // Prompt that color of node has been set at node (x,y) to color (color)
    }

    void API::clearColor(int x, int y) { // Definition of clearColor Function
        std::cout << "clearColor " << x << " " << y
                  << std::endl; // Prompt that color of node has been cleared at node (x,y)
    }

    void API::clearAllColor() { // Definition of clearAllColor Function
        std::cout << "clearAllColor" << std::endl; // Prompt that color of all nodes have been cleared
    }

    void API::setText(int x, int y, const std::string &text) { // Definition of mazeWidth Function
        std::cout << "setText " << x << " " << y << " " << text
                  << std::endl; // Prompt that the text of node at (x,y) has been set to (text)
    }

    void API::clearText(int x, int y) { // Definition of clearText Function
        std::cout << "clearText " << x << " " << y << std::endl; // Prompt that text of node at (x,y) has been cleared
    }

    void API::clearAllText() { // Definition of clearAllText Function
        std::cout << "clearAllText" << std::endl; // Prompt that text of all nodes has been cleared
    }

    bool API::wasReset() { // Definition of wasReset Function
    ...
    void API::ackReset() { // Definition of ackReset Function
